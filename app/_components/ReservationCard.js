...
function ReservationCard({ booking, onDelete }) {
  ...
  return (
    <div className="flex border border-primary-800 sm:flex-col lg:flex-row">
      <div className="relative aspect-video basis-[25%]">
        <Image
          fill
          src={image}
          alt={`Cabin ${name}`}
      ...
      {!isPast(new Date(startDate)) && (
        <div className="flex w-[100px] flex-col border border-l border-primary-800">
          <Link
